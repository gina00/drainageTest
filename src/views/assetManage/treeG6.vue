      ...
      <div class="itemBox" :span="24">
        <el-row :gutter="10" class="flex-box">
          ...
          <el-col :span="2" class="mt10">
            <el-checkbox
              v-model="searchParam.radioTime"
              @change="isShowTimeinfo"
            >显示时间</el-checkbox>
          </el-col>
          <el-col :span="2" class="mt10">
            <el-checkbox
              v-model="searchParam.radioItemStatus"
              @change="isShowItemStatus"
            >显示状态</el-checkbox>
          </el-col>
          <el-col :span="2">
        ...
        <div class="canvaBox">
          ...
          >
            <el-input v-model="inputLabel.name" placeholder="请输入" />
    ...
    >
      <el-form ref="dataInfoForm" :model="dataInfoForm" label-width="90px">
        <el-form-item label="节点名称">
          <el-col :span="11">
            <el-input v-model="dataInfoForm.name" />
          </el-col>
        </el-form-item>
        <el-form-item label="人员数量">
          <el-col :span="11">
            <el-input v-model="dataInfoForm.employeesTotal" />
          </el-col>
        </el-form-item>
...
export default {
  ...
  methods: {
      ...
      const menu = new Menu({
        ...
        handleMenuClick(target, item) {
          if (target.id == 'addLabel') {
            ...
            that.dataInfoForm.startTime = new Date()
            that.dataInfoForm.endTime = new Date()
    ...
    findNodesByModels(arr) {
      ...
      if (arr) {
        arr.map((item) => {
          const findobj = graph.findById(item.id)
          if (findobj) {
            // 保存选中节点
